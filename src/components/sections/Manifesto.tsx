    ...
    <section className="manifesto section section--light" id="about">
      <div className="section-frame"><SectionEyebrow number="01" children="THE THESIS" />
        <div className="manifesto__layout parallax-target" data-parallax data-parallax-x="-10" data-parallax-y="16">
          ...
          <div className="manifesto__copy reveal reveal--right" data-reveal><span className="micro-label">A brief introduction</span><h2>I build at the edge of <em>clarity</em>.</h2><p className="lede">The best digital products do not ask for attention. They earn it. I’m Joseph Mulwa — a full-stack developer eager to turn ambitious ideas into useful, expressive systems.</p><p>I work across web-development, system design and the space between them: translating a sharp question into an interface people can trust, then giving it the architecture to grow.</p><button className="text-button text-button--dark" type="button" onClick={() => scrollTo("projects")}>See selected work <ArrowUpRight size={15} /></button>
