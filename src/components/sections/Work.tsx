...
const projects = [
  ...
  },
  {
    ...
    focus: "Visual Design",
    title: "Prism\nUI",
    description: "A design system built for speed and clarity in complex data environments.",
    image: REFERENCE_IMAGES.goldenCode,
    accent: "gold",
    tags: ["React", "Tailwind", "Framer Motion"],
    github: "https://github.com/josephmulwa/prism-ui",
    livePreview: "https://prism-ui.vercel.app",
  },
  {
    index: "03",
    category: "Frontend" as ProjectCategory,
    ...
    title: "Flux\nCanvas",
    description: "Generative art experiments exploration using WebGL and Shaders.",
    image: REFERENCE_IMAGES.memento,
    accent: "violet",
    tags: ["Three.js", "GLSL", "React"],
    github: "https://github.com/josephmulwa/flux-canvas",
    livePreview: "https://flux-canvas.vercel.app",
  },
  {
    index: "04",
